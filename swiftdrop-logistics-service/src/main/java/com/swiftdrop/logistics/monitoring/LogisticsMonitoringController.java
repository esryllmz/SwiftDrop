...
public class LogisticsMonitoringController {

    private static final String INTERNAL_API_KEY_HEADER = "X-Internal-Api-Key";

    private final LogisticsMonitoringService monitoringService;
    private final String internalApiKey;

    public LogisticsMonitoringController(
            LogisticsMonitoringService monitoringService,
    ...
    @GetMapping
    public ResponseEntity<LogisticsMonitoringResponse> getMonitoring(
